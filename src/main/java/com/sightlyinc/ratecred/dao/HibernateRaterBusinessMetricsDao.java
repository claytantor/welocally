...
public class HibernateRaterBusinessMetricsDao 
	extends HibernateDaoSupport 
	implements RaterBusinessMetricsDao {

	static Logger logger = Logger.getLogger(HibernateRaterBusinessMetricsDao.class);
	...
	public List<RaterBusinessMetrics> mineBusinessMetricsForRaters(
		...
		List<RaterBusinessMetrics> execute = 
			(List<RaterBusinessMetrics>)getHibernateTemplateOverride().execute(new HibernateCallback() {
			public Object doInHibernate(final Session session)
				throws HibernateException, SQLException 
				{
					final List<RaterBusinessMetrics> result = new ArrayList<RaterBusinessMetrics>();
		...
		List<RaterBusinessMetrics> result = 
			execute;
		return result;
	}
	...
	public List<RaterBusinessMetrics> mineBusinessMetricsForDateRange(
		...
		List<RaterBusinessMetrics> execute = (List<RaterBusinessMetrics>)getHibernateTemplateOverride().execute(new HibernateCallback() {
			public Object doInHibernate(final Session session)
				throws HibernateException, SQLException 
				{
					final List<RaterBusinessMetrics> result = new ArrayList<RaterBusinessMetrics>();
	...
	private RaterBusinessMetrics makeFromResult(List rRater, Long id, Date startDate, Date endDate)
	{
		RaterBusinessMetrics tbm = new RaterBusinessMetrics();
		tbm.setRaterId(id);
