...
<div class="container">
	<div class="span-24">
        <h2><a href="<c:url value='/admin/place/list' />">all places</a> : ${place.url}</h2>
        <hr/>
        <div class="actions span-24 last">
            <a href="<c:url value='/admin/place/edit/${place.id}' />" class="button">edit</a>
            <a href="<c:url value='/admin/place/delete/${place.id}' />" class="button">delete</a>
        </div>
