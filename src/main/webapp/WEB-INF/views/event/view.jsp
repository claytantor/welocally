...
<div class="container">
	<div class="span-24">
		<h2><a href="<c:url value='/admin/event/list' />">all events</a> : ${event.name}</h2>
		<hr/>
		<div class="actions span-24 last">
			<a href="<c:url value='/admin/event/edit/${event.id}' />" class="button">edit</a>
			<a href="<c:url value='/admin/event/delete/${event.id}' />" class="button">delete</a>
		</div>
