...
<div class="container">
	<div class="span-24">
		<h2><a href="<c:url value='/' />">home</a> : list of reviews</h2>
		<hr/>
		<div class="actions span-24 last">
			<a href="<c:url value='/admin/review' />" class="button">create</a>
		</div>		
		<div class="span-24 last">
			<c:forEach var="review" items="${reviews}">
			<div class="span-24 last">
				<div class="strong-12 span-1">${review.id}</div>
				<div class="strong-12 span-6"><a href="<c:url value='/admin/review/${review.id}'/>">${review.url}</a></div>
				<div class="span-10">
