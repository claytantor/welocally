...
#new adility integrations
ALTER TABLE `ratecred_080_etl`.`award_offer` MODIFY COLUMN `external_id` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL;

ALTER TABLE `ratecred_080_etl`.`award_offer` ADD COLUMN `discount_type` VARCHAR(45) AFTER `expire_millis`,
...
ALTER TABLE `ratecred_080_etl`.`business` ADD COLUMN `advertiser_id` VARCHAR(255) AFTER `guid`,
 ADD COLUMN `advertiser_source` VARCHAR(45) AFTER `advertiser_id`; 
 
CREATE TABLE `ratecred_080_etl`.`cust_order` (
...
CREATE TABLE `ratecred_080_etl`.`voucher` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `version` INT,
  `time_created` BIGINT(20),
  `time_updated` BIGINT(20),
...
CREATE TABLE `ratecred_080_etl`.`award_awardoffer` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `award_id` BIGINT(20),
...
CREATE TABLE `ratecred_080_etl`.`award_offer_item` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `version` INT,
  `time_created` BIGINT(20),
  `time_updated` BIGINT(20),
