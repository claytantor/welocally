...
import com.sightlyinc.ratecred.model.ItemSku;

public class ItemSkuDaoImpl 
	extends AbstractDao<ItemSku> 
	implements ItemSkuDao {

	static Logger logger = Logger.getLogger(ItemSkuDaoImpl.class);
